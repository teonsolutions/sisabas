...
*@since 07/11/2017
*@version gandalf 4.0*/
public class Vcentrocosto extends SysTabla implements  Serializable,Cloneable{
	...
	public Vcentrocosto(java.lang.String codigocentrocosto) {
		this.codigocentrocosto=codigocentrocosto;
	 }

	@Override
	public boolean equals(Object obj){
		if(obj!=null && obj instanceof Vcentrocosto)
			return ((Vcentrocosto)obj).getCodigocentrocosto().equals(this.getCodigocentrocosto()) ;
		else
			return false;
	 }
	...
	public String toString(){
		 return ((this.codigocentrocosto!=null)?("codigocentrocosto:\t" + this.codigocentrocosto+"\n"):"" ).concat(
